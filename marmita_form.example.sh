...
BODY_MD_TEXT="# Episode ${EPISODE_NUMBER} - ${TITLE}
...
ARCHIVE_ORG_IDENTIFIER="test-mypodcast-${_sxxexx}"    # archive.org unique identifier
...
POST_PATH="../website/content/post/${_sxxexx}.md"                               # Hugo website
ARCHIVE_ORG_DETAILS_URL="https://archive.org/details/${ARCHIVE_ORG_IDENTIFIER}" # link for uploaded content

THUMBNAIL_URL="https://archive.org/download/${ARCHIVE_ORG_IDENTIFIER}/$(basename "${THUMBNAIL_PATH}")"
